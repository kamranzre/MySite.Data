    ...
    public class SmartFormEnTagHelper : FormTagHelper
    {
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            if (!IsPartialView)
            {
                ...
                {
                    searchBtn = $"<button type='button' id='submit-{FormId}' onclick='{SearchButtonJs};' class='btn btn-success btn-labeled'><span>{"Search"}</span> <b><i class='fa fa-check-circle'></i></b></button>";
                ...
                if (!RemoveButton)
                {
                    ...
                    cancelBtn = $"<button type='button' onclick=\"OpenWindowCreate('/{ControllerName}/{ActionName}',{parameters},'{ControllerName}');\" class='btn bg-slate btn-labeled legitRipple'><span>{"Cancel"}</span> <b><i class='fa fa-times-circle'></i></b></button>";
